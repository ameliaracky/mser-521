...
async function getChartData() {
  const sheetName = 'Amelia Snow Days';
...
async function createChart() {
  ...
  const options = {
    ...
    colors: ['#02340aff', '#5ad66eff'], // series 1 and series 2 colors
    plotOptions: {
      bar: {
        horizontal: false,
      },
    ...
    series: [
      { name: 'Money Made 2023-2024', data: snowDays1 },
      { name: 'Money Made 2024-2025', data: snowDays2 },
    ],
